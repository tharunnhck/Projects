            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="banner_content"> 
                        <h1>Explore Our Exciting Offers</h1>
                        <p>Find the perfect car for your next adventure!</p>
                        <a href="#" class="btn btn-primary" onclick="scrollToBestCarSection()">Book Now</a>
                    </div>
                </div>
            </div>
        </div>
...
<!-- Resent Car -->
<section id="bestCarSection" class="section-padding gray-bg">
    <div class="container">
        <div class="section-header text-center">
            <h2>Find the Best <span>Car For You</span></h2>
            <p>We at Sai Car Rentals provide you with the best car for rent at a affordable price. Our cabs are well maintained and sanitized after every ride. Experience a smooth and comfortable ⭐⭐⭐⭐⭐ ride with us.</p>
        </div>
        <div class="row"> 
            <!-- Nav tabs -->
                ...
                <div role="tabpanel" class="tab-pane active" id="resentnewcar">
                    ...
                    <div class="col-list-3">
                        <div class="recent-car-list">
                            ...
                            <div style="padding:10px;" class="car-title-m">
...
<script>
    function scrollToBestCarSection() {
        var element = document.getElementById('bestCarSection');
        if (element) {
