...
<head>
	...
	<title>Sai Rentals | Admin Post Vehicle</title>
...
<label for="leatherseats"> Leather Seats </label>
											...
											<div class="form-group">
												<div class="col-sm-8 col-sm-offset-2">
													<br>
													<a href="dashboard.php" onclick="return confirm('Do you really want to cancel! any changes made will be lost')" class="btn btn-danger">Cancel</a>
													<button onclick="return confirm('Do you really want to reset?!')" class="btn btn-default" type="reset">Reset</button>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
