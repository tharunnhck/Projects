...
<head>
	...
	<title>Sai Rentals | Admin Update Image 2</title>
...
<?php 
$id=intval($_GET['imgid']);
$sql ="SELECT Vimage2,id from tblvehicles where tblvehicles.id=:id";
$query = $dbh -> prepare($sql);
$query-> bindParam(':id', $id, PDO::PARAM_STR);
$query->execute();
...
<?php }}?>
											...
											<div class="form-group">
												<div class="col-sm-8 col-sm-offset-4">
													<a href="edit-vehicle.php?id=<?php echo $result->id;?>"  class="btn btn-danger">Cancel</a>
