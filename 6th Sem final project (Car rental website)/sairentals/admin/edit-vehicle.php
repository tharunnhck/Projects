...
<head>
	...
	<title>Sai Rentals | Admin Edit Vehicle Info</title>
...
<div class="form-group">
<div class="col-sm-4">
Image 1 &nbsp<img src="img/vehicleimages/<?php echo htmlentities($result->Vimage1);?>" width="300" height="200" style="border:solid 1px #000">
<br>
<br>
&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<a href="changeimage1.php?imgid=<?php echo htmlentities($result->id)?>" class="btn btn-default">Change Image 1</a>
</div>
<div class="col-sm-4">
Image 2&nbsp&nbsp<img src="img/vehicleimages/<?php echo htmlentities($result->Vimage2);?>" width="300" height="200" style="border:solid 1px #000">
<br>
<br>
&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<a href="changeimage2.php?imgid=<?php echo htmlentities($result->id)?>" class="btn btn-default">Change Image 2</a>
</div>
<div class="col-sm-4">
Image 3&nbsp&nbsp<img src="img/vehicleimages/<?php echo htmlentities($result->Vimage3);?>" width="300" height="200" style="border:solid 1px #000">
<br>
<br>
&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<a href="changeimage3.php?imgid=<?php echo htmlentities($result->id)?>" class="btn btn-default">Change Image 3</a>
...
<br>
<br>
&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<a href="changeimage4.php?imgid=<?php echo htmlentities($result->id)?>" class= "btn btn-default">Change Image 4</a>
...
<br>
<br>
&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<a href="changeimage5.php?imgid=<?php echo htmlentities($result->id)?>" class= "btn btn-default">Change Image 5</a>
...
<?php }} ?>
											...
											<div class="form-group">
												<div class="col-sm-8 col-sm-offset-2">
													<br>
													<a href="manage-vehicles.php" onclick="return confirm('Do you really want to cancel! any changes made will be lost')" class="btn btn-danger">Cancel</a>
